...
class DAOUsuario
{
    ...
    /**
     * Obtiene los tupperwares de todos los usuarios para una fecha específica.
     * @param string $fecha La fecha para la cual se desean obtener los tupperwares.
     * @return array|null Un array de objetos que contienen los tupperwares de los usuarios para la fecha dada.
     */
